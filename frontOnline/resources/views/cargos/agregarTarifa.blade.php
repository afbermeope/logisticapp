                    ...
                    <form id="agregarTarifa">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="valor" name="valor" placeholder="Ingrese el valor de la tarifa" required>
                            </div>
                            <div class="form-group">
                                <label for="hora">Hora</label>
                                <input type="text" class="form-control" id="hora" name="hora" placeholder="Ingrese el hora de la tarifa" required>
                            </div>
                        </div>
