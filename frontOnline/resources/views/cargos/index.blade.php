            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">Agrega un cargo</h3>
                    </div>
                    <!-- /.card-header -->
                ...
                <div class="col-md-8">
                    <div class="card card-secondary">
                        ...
                        <div class="card-body">
                            <table id="cargo-table" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th>Nombre</th>
                                        <th>Fecha inicio</th>
                                        <th>Fecha fin</th>
                                        <th>Días del cargo</th>
                                        <th>Editar</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {{-- @foreach ($cargos as $cargo)
                                        <tr>
                                            ...
                                            <td>{{ $cargo->dias }}</td>
                                            <td>
                                                <a href="{{ route('cargo.edit', $cargo->id) }}" target="_blank">
...
<script>
    $(function () {
      ...
      }).buttons().container().appendTo('#cargo-table_wrapper .col-md-6:eq(0)');
    });
</script>
